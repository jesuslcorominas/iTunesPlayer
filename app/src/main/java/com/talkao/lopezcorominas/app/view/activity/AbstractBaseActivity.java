...
import com.talkao.lopezcorominas.app.event.FakeEvent;
import com.talkao.lopezcorominas.app.presenter.Presenter;
import com.talkao.lopezcorominas.app.utils.Navigator;
...
abstract class AbstractBaseActivity<V extends CallbackView> extends Activity implements CallbackView {
     ...
     * @see com.talkao.lopezcorominas.app.event.FakeEvent
     */
